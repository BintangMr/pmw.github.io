!(function (e, t) {
    ...
    function n(e, t) {
        ...
        return (
            ((n = a.call(this, r) || this).store = t),
                ...
                n.store.addEventListener("seatchange", n.stateEventListener, { index: e }),
                n
        );
    }
    var i,
    ...
    function o() {
        ...
        return (e.textContent = "Layar"), (e.className = "sc-front"), i.call(this, e) || this;
    }
    var s,
        l = (e(c, (s = t)), c);
    function c(e) {
        ...
        L =
            (e(T, (x = t)),
                (T.prototype.updateTotalText = function () {
                    ...
                    this.element.textContent = "Total: ".concat(this.currency).concat(e.toFixed(2));
                }),
                T);
    function T(e) {
        var t = this,
    ...
    function k(e) {
        ...
        return (
            (a.className = "sc-cart-btn sc-cart-btn-submit"),
                (a.textContent = (null == r ? void 0 : r.submitLabel) || "Pesan Tiket"),
                (a.type = "button"),
                (a.onclick = function () {
                    window.simpanPemesanan(e)
                    return e.submit();
                }),
        ...
        j =
            (e(_, (R = t)),
                ...
                (_.prototype.updateCartTitle = function () {
                    ...
                    this.title.textContent = "Keranjang (".concat(e, ")");
                }),
                _);
    function _(e) {
        var t = this,
    ...
    function z(e) {
        ...
        var m = new X("Sudah di book", "sc-seat-reserved");
        ...
        ee =
            ((te.prototype.init = function () {
                ...
                (te.prototype.setSeat = function (e, t, n) {
                    ...
                    if (
                        (i.state !== t.state && ("selected" === o.state ? this.addToCart(o.index, n) : "selected" === i.state && this.removeFromCart(o.index, n)),
                ...
                (te.prototype.clearCart = function (e) {
                    var t,
                        ...
                        a,
                        i = (function (e, t, n) {
                            if (n || 2 === arguments.length) for (var r, a = 0, i = t.length; a < i; a++) (!r && a in t) || ((r = r || Array.prototype.slice.call(t, 0, a))[a] = t[a]);
                            ...
                            (function (e, t) {
                                ...
                                var r,
                                    ...
                                    o = [];
                                try {
                                    for (; (void 0 === t || 0 < t--) && !(r = i.next()).done; ) o.push(r.value);
                                } catch (e) {
                                    a = { error: e };
                                } finally {
                                    try {
                ...
                (te.prototype.getRowLabel = function (e) {
                    var t,
                        n = null === (t = this.options.map.indexerRows) || void 0 === t ? void 0 : t.label;
                    if (n) return n(e);
                ...
                (te.prototype.getColumnLabel = function (e) {
                    var t,
                        n = null === (t = this.options.map.indexerColumns) || void 0 === t ? void 0 : t.label;
                    ...
                    try {
                        for (var c = y(s), l = c.next(); !l.done; l = c.next()) {
                            var d = l.value,
                                u = o[d];
                            if (
                                (null === (r = u.seats) || void 0 === r ? void 0 : r.some(this.isSameSeat(t))) ||
    ...
    function te(e) {
        (this.cart = []),
            ...
            (this.eventListeners = { cartchange: [], cartclear: [], seatchange: [], submit: [] });
